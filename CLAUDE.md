...
content/
  ...
  lab/*.md              # one file per card (dashboards, frameworks, datasets) —
                        # rendered as Practice's horizontal card stream (merged 2026-08-23;
                        # the word "artifact" is retired from the UI)
```
